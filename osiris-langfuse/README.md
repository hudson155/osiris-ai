...
`software.airborne.osiris:osiris-langfuse:0.23.0`
...
dependencies {
  ...
  implementation("software.airborne.osiris:osiris-langfuse-tracing:0.23.0")

  /**
   * Also include one of the following,
   * depending on whether you're using the chat module or the agentic framework.
   */
  implementation("software.airborne.osiris:osiris-chat:0.23.0")
