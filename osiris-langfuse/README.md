...
`software.airborne.osiris:osiris-langfuse:0.18.0`
...
dependencies {
  implementation("software.airborne.osiris:osiris-langfuse:0.18.0")

  /**
   * Also include at least one of the following peers.
   */
  implementation("software.airborne.osiris:osiris-langfuse-prompt:0.18.0") 
  implementation("software.airborne.osiris:osiris-langfuse-tracing:0.18.0")
