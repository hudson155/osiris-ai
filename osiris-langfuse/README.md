...
`software.airborne.osiris:osiris-langfuse:0.21.1`
...
dependencies {
  implementation("software.airborne.osiris:osiris-langfuse:0.21.1")

  /**
   * Also include at least one of the following peers.
   */
  implementation("software.airborne.osiris:osiris-langfuse-prompt:0.21.1") 
  implementation("software.airborne.osiris:osiris-langfuse-tracing:0.21.1")
