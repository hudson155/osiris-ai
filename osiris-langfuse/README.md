...
`software.airborne.osiris:osiris-langfuse:0.29.0`
...
dependencies {
  implementation("software.airborne.osiris:osiris-langfuse:0.29.0")

  /**
   * Also include at least one of the following peers.
   */
  implementation("software.airborne.osiris:osiris-langfuse-prompt:0.29.0") 
  implementation("software.airborne.osiris:osiris-langfuse-tracing:0.29.0")

  /**
   * Also include one of the following,
   * depending on whether you're using the chat module or the agentic framework.
   */
  implementation("software.airborne.osiris:osiris-chat:0.29.0")
  implementation("software.airborne.osiris:osiris-agentic:0.29.0")
}
```
