...
`software.airborne.osiris:osiris-langfuse:0.24.0`
...
dependencies {
   ...
   */
  implementation("software.airborne.osiris:osiris-langfuse-prompt:0.24.0") 
   ...
   */
  implementation("software.airborne.osiris:osiris-chat:0.24.0")
